...
WebTrends.prototype.dcsMultiTrack=function(){
	...
	if (this.savehref!="")
	{
		var s="document.location='"+this.savehref+"';";
		var t=setTimeout(s,500);
		this.savehref="";
	}
		this.dcsTag();
	}
