...
/**	ccc rights link */
function RightslinkPopUp(aPublisher, aPublication, aTitle, aDate, aAuthor, aContentId, aCopyright, aVolume, aIssue, aStartPage, aEndPage, aIssn, aOrderBeanReset, aColor, aReprints, aPermissions)
{
	var location =
...
// pubmed url format:
// http://www.ncbi.nlm.nih.gov.proxy.library.emory.edu/entrez/query.fcgi
//   ?dopt=DocSum&cmd=Search&db=PubMed
//   &term=Bhatnagar[AU]+OR+Bagchi[AU]
//
function showPubMedSearch(aAuthors, aKeywords)
{
	var pmurl = "http://www4.ncbi.nlm.nih.gov.proxy.library.emory.edu/PubMed/";
	if ((aAuthors.length>0) || (aKeywords.length>0))
	{
		pmurl = "http://www.ncbi.nlm.nih.gov.proxy.library.emory.edu/entrez/query.fcgi?dopt=DocSum&cmd=Search&db=PubMed&term=";
...
// xrs url format:
// http://www.google.com.proxy.library.emory.edu/cobrand?restrict=crossref&sa=Search+
//	&q=%22stem+cell%22+%22type+1%22&cof=AWPID:bbd6d01e9a530922
function showCrossRefSearch(aAuthors, aKeywords)
{
	var xrsurl = "http://www.google.com.proxy.library.emory.edu/cobrand?restrict=crossref&sa=Search+&filter=0&q=";
	if ((aAuthors.length>0) || (aKeywords.length>0))
	{
...
function submitXrsSearch(frm)
{
	...
	var xrsurl = "http://www.google.com.proxy.library.emory.edu/cobrand?" +
