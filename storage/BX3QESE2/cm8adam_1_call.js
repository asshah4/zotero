...
var nav=window.navigator||{};function ipU()
{function euU(v)
...
return uuU.join("");};return ("&LOC=" +CM8GetLocation().substr(0,1000) +DE4() +getTime() +"&OS=" +os() +ipU() +"&JE=" +(((typeof(nav.javaEnabled) !="undefined")&&nav.javaEnabled())?1:0) +(lang?("&UL=" +lang):"") +zpU() +"&ORD=" +String(Math.random()).slice(2));})();
