...
function gs3_illumina(link) {			
	parent.iframe1.location.href = link.getAttribute("href");
	parent.getHighLightXml();	
	parent.setHiddenGs3Link(link.getAttribute("href"));			
	window.setTimeout("parent.getHighLightXml()",1000);				
}