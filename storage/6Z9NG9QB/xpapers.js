...
if (!_this.eId) {
alert("Submission successful. Please note that it can take up to 30 minutes for changes to be reflected everywhere on the site.");
}
if ($('e' + _this.eId))
...
var language= "en";
var url = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=" + key + "&lang=" + language + "&text=" + encodeURIComponent(title) + "&text=" + encodeURIComponent(author_abstract) + "&callback=?";
...
abstractElement.update(data.text[1]);
}
