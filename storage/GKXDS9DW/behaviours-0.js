...
site.toggleList = function() {
    ...
    jQuery('.collapser').click(function() {
        ...
        if($("span.toggletext").length > 0) { $("a.collapser span").toggle();  }
...
jQuery(document).ready(function() {
    ...
    if ((site.id == "3009" || site.id == "3008") && site.page == "home" && window.bmcIsMobile != "mobile") {
    ...
    if($("#videoarticle").length > 0) {
        $("#videoarticle").click(function(e) {
            e.preventDefault();
               $f("videoarticle", "http://releases.flowplayer.org/swf/flowplayer-3.2.7.swf", {
                 buffering: true,
                 clip: {
                   autoPlay: true,
                   autoBuffering: true,
