...
function WebTrends(journal_dcsid, domain, fpcdom) {
    ...
    this.dcsid = journal_dcsid;
    this.domain = domain;  //"statse.webtrendslive.com";
    this.timezone = -5;
    this.fpcdom = fpcdom;
    this.metanames = "wkhealth_journal_title,wkhealth_volume,wkhealth_issue,wkhealth_ovid_accession_number,wkhealth_issn,wkhealth_title,wkhealth_blog_title,wkhealth_authors,wkhealth_date,wkhealth_firstpage,wkhealth_toc_section,wkhealth_toc_sub_section,wkhealth_eJpId,wkhealth_user_profession,wkhealth_user_speciality,wkhealth_collection_title";
    this.enabled = true;
    this.i18n = false;
    this.fpc = "WT_FPC";
    // end: user modifiable
...
WebTrends.prototype.dcsMetaCap = function(evt) {
    var elems;
    if (document.all) {
