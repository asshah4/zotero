...
(function($) {
    ...
    $.fn.subjectTree = function() {
        return this.each(function() {
            $(this).find(">li").hover(function(){
                ...
                div.css("width", $(this).find("ol").length * 15 +"em");
                $(this).addClass("hover");
        ...
        this.each(function() {
            $(this).click(function() {
                ...
                if(branch && branch.css("display") == "block") {
                    ...
                    $.ajax({
                        type :"GET",
                        url :"issues/fragment?activeYear=" + year + "&SKIP_DECORATION=true",
                        dataType : "html",
                        beforeSend : function() {
    ...
    $.fn.addResourceMenu = function(){
      var resources = {
             "1" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-390244.html","text":"Training and Tutorials"},
             "2" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-404512.html","text":"For Researchers"},
             "3" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-404513.html","text":"For Librarians"},
             "4" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-404518.html","text":"For Societies"},
             "5" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-404516.html","text":"For Authors"},
             "6" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-390236.html","text":"For Advertisers"},
             "7" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-390242.html","text":"For Media"},
             "8" : {"link":"http://olabout.wiley.com.proxy.library.emory.edu/WileyCDA/Section/id-390243.html","text":"For Agents"}
            };
    ...
    $.fn.jumpList = function(){
        ...
        select.css("visibility", "hidden").appendTo("body").end().each(function(){
        	var select = $(this);
        	$(this).find("option:first").each(function(){
        		if($(this).width() <= 550){
                    select.css("width", (($(this).width() < 238) ? 238 : $(this).width()+20));
                }else if($(this).width() > 500){
                	select.css({"clear": "left", "width": 740, "margin-left":0});
                }
    		});
        }).detach().css("visibility", "visible");
